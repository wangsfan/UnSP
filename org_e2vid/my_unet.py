...
from org_e2vid.submodel import ConvLayer, UpsampleConvLayer, TransposedConvLayer, RecurrentConvLayer, ResidualBlock, ConvLSTM, ConvGRU, UpConvLayer, SPADE
...
class BaseUNet(nn.Module):
    def __init__(self, num_input_channels, num_output_channels=1, skip_type='sum', activation='sigmoid',
        ...
        if use_upsample_conv:
            ...
            self.UpsampleLayer = UpConvLayer
...
class UNetRecurrent(BaseUNet):
    ...
    def forward(self, x, prev_states):
        ...
        # tail
        x = self.pred(self.apply_skip_connection(x, head))
